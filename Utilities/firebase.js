...
//     console.warn("To enable Firebase, add serviceAccountKey.json to Utilities folder.");
// }
...
exports.generateAlarmNotification = function (topic, deviceID, notificationType, title, body, data1, data2, data3, data4, data5, channelId, attachmentType, attachmentUrl) {
    try {
        var data = {
            notificationType: notificationType,
            title: title,
            ...
            const payload = {
                ...
                android: {
                    notification: {
                        sound: 'alarm_sound',
                        channelId: 'custom',
                        click_action: "com.uvtechsoft.dimensions.STOP_ALARM"
                    },
                },
                apns: {
                    payload: {
